# En este archivo se crean algunas propiedades de las matrices


class Matriz:
    def __init__(self, matriz: list):
        if isinstance(matriz[0], list):
            # Matrices bien formadas
            self.matriz = matriz
        else:
            # Matrices 1D A=[1, 2, 3]
    ...
    def __str__(self):
        """
        Formatea la matriz para que se vea como un arreglo matematico.
        """
    ...
    def __add__(self, B: list[list[float]]):
        ...
        Example:
            ...
            [2, 2]]
        """
        # Checamos si la matriz es un objeto de la clase para evitar errores despues
    ...
    def __mul__(self, B: list[list[float]]):
        """
        Realiza la multiplicacion de dos matrices utilizando el operador *.
    ...
    def t(self):
        ...
        """
        At = []
        # Los vectores acostados deben tener la misma cantidad de elementos,
        # entonces escogemos el primero para saber la cantidad de columnas de la matriz

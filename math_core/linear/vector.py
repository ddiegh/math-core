# En este archivo construimos algunas propiedades de los vectores
...
class Vector:
    ...
    def __rmul__(self, c: float):
        """
        Devuelve el vector escalado (nos permite hacerlo de forma c * v).
    ...
    def dot(self, u: list[float]) -> int:
        ...
        # Multiplicamos cada entrada y luego sumamos todo
        return sum(vi * ui for vi, ui in zip(self.v, u))
